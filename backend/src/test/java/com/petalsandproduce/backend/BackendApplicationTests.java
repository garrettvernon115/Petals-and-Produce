...
class BackendApplicationTests {
    ...
    void setup() {
        ...
        incorrectPassword.put("username", username);
        incorrectPassword.put("email", email);
        incorrectPassword.put("password", "wrong");
 
        incorrectEmail = new HashMap<>();
        incorrectEmail.put("name", "John Computer");
        incorrectEmail.put("username", username);
